...
Caso seja feita a exclusão, deverá atualizar o número de vagas no hotel ao longo
de todo o período, excluindo o número do CPF do cliente nos dias referentes ao
...
{
    int a,q,cpf,cont,andar,quarto,vagas;
    vagas=0;
